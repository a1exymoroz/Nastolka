...
// `t(\`meeples.${game}.${slug}\`)` (see src/i18n/locales) since it's
// user-facing text.
export const TOKEN_SETS = {
  ...
  // TODO(brass-birmingham-sprites): placeholder shape/color data — swap in
  // the real flat single-path SVGs once supplied (see
  // src/assets/animals/brassbirmingham_*.svg).
  'brass birmingham': [
    {
      id: 'brassbirmingham_owen',
      slug: 'owen',
      viewBox: '0 0 300 400',
      color: '#4b3f72',
      path: 'M 150.00,40.00 L 210.00,90.00 L 220.00,180.00 L 190.00,260.00 L 220.00,340.00 L 80.00,340.00 L 110.00,260.00 L 80.00,180.00 L 90.00,90.00 Z',
    },
    {
      id: 'brassbirmingham_arkwright',
      slug: 'arkwright',
      viewBox: '0 0 300 400',
      color: '#7a5230',
      path: 'M 150.00,40.00 L 210.00,90.00 L 220.00,180.00 L 190.00,260.00 L 220.00,340.00 L 80.00,340.00 L 110.00,260.00 L 80.00,180.00 L 90.00,90.00 Z',

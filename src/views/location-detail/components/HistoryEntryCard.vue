...
<template>
  ...
  >
    ...
    <div class="min-w-0 flex-1">
      ...
      <ol v-if="entry.state === 'FINISHED' && !entry.outcome" class="mt-2 list-none space-y-1">
      ...
      <ul v-else class="mt-2 list-none space-y-1">
      ...
      <div v-if="entry.state === 'FINISHED'" class="mt-3">
        <HistoryVoteWidget
          compact
          :my-vote="myVote"
